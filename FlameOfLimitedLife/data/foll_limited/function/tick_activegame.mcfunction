...
execute as @a[tag=foll-limited-player, tag=!foll-ghost] run execute if score @s foll_player_lifetime_s matches 0..9 if score @s foll_player_lifetime_m matches 0..9 run title @s actionbar ["Lifetime: ", {score: {name: "*", objective: "foll_player_lifetime_h"}}, ":", {text:"0", color:"yellow"}, {score: {name: "*", objective: "foll_player_lifetime_m"}}, ":", {text:"0", color:"red"}, {score: {name: "*", objective: "foll_player_lifetime_s"}} ]
execute as @a[tag=foll-limited-player, tag=!foll-ghost] run execute if score @s foll_player_lifetime_s matches 10.. if score @s foll_player_lifetime_m matches 0..9 run title @s actionbar ["Lifetime: ", {score: {name: "*", objective: "foll_player_lifetime_h"}}, ":", {text:"0", color:"yellow"}, {score: {name: "*", objective: "foll_player_lifetime_m"}}, ":", {score: {name: "*", objective: "foll_player_lifetime_s"}} ]
execute as @a[tag=foll-limited-player, tag=!foll-ghost] run execute if score @s foll_player_lifetime_s matches 0..9 if score @s foll_player_lifetime_m matches 10.. run title @s actionbar ["Lifetime: ", {score: {name: "*", objective: "foll_player_lifetime_h"}},":", {score: {name: "*", objective: "foll_player_lifetime_m"}}, ":", {text:"0", color:"red"}, {score: {name: "*", objective: "foll_player_lifetime_s"}} ]
execute as @a[tag=foll-limited-player, tag=!foll-ghost] run execute if score @s foll_player_lifetime_s matches 10.. if score @s foll_player_lifetime_m matches 10.. run title @s actionbar ["Lifetime: ", {score: {name: "*", objective: "foll_player_lifetime_h"}},":", {score: {name: "*", objective: "foll_player_lifetime_m"}}, ":", {score: {name: "*", objective: "foll_player_lifetime_s"}} ]

#> Change player team suffix to reflect remaining time
execute as @a[tag=foll-limited-player, tag=!foll-ghost] run function foll_limited:lifetimetagloop
...
function foll_limited:event_windetect
